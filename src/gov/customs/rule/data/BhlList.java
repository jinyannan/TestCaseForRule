...
/**
 * BhlList generated by hbm2java
 */
public class BhlList implements java.io.Serializable {

	private BhlListId id;
	...
	public BhlList(BhlListId id) {
		this.id = id;
	}

	public BhlList(BhlListId id, String eportNo, BigDecimal emsGNo,
	...
	public BhlListId getId() {
		return this.id;
	}

	public void setId(BhlListId id) {
		this.id = id;
	}
