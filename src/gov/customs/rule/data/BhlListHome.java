 ...
 * @see gov.customs.rule.data.BhlList
	...
	public List<BhlList> findByExample(BhlList instance) {
		...
		try {
			List<BhlList> results = (List<BhlList>) sessionFactory
					.getCurrentSession()
					.createCriteria("gov.customs.rule.data.BhlList")
